...
<head>
  <meta charset="utf-8">
  <title>GSV Internship Portal</title>
...
<body>
  ...
  <header id="header">
    <div class="container-fluid">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="#intro" class="scrollto">GSV Internship Portal</a></h1>
    ...
    <section id="about">
      <div class="container">
        ...
        <header class="section-header">
          <h3>About Us</h3>
          <p> This portal is only for the students of GSV. </p>
        </header>
      </div>
    </section>
    ...
    <section id="team">
      <div class="container">
        ...
        <!-- <div class="row">
          ...
          <!-- <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.4s">
            <div class="member">
              <img src="img/shivam.jpg" class="img-fluid" alt="">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Shivam Pathak</h4>
                  <span> GSV </span>
                  <span> MBA Logistics and Supply Chain Management </span>
                  <span> Roll No. 2340030</span>
                  <div class="social">
                    <a href="https://www.linkedin.com/in/shivam-pathak-386473239"><i class="fa fa-linkedin"></i></a> -->
                    <!-- <a href=""><i class="fa fa-instagram"></i></a> -->
                    <!-- <a href="github link to be pasted if req..."><i class="fa fa-github"></i></a> -->
                  <!-- </div>
                </div>
              </div>
            </div>
        ...
        <div class="row contact-info">
          ...
          <div class="col-md-4">
            <div class="contact-address">
              ...
              <h3>Address</h3>
              <address> Gati Shakti Vishwavidyalaya, A Central University under the Ministry of Railways, Government of India, Lalbaug, Vadodara, Gujarat, 390004 </address>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="contact-phone">
              ...
              <h3>Phone Number</h3>
              <p><a href="tel:+91 9158200692">+91 9313921040</a></p>
              <p><a href="tel:+91 7718905532">+91 9313921041</a></p>
              <p><a href="tel:+91 7506562416">+91 9313921042</a></p>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="contact-email">
              ...
              <h3>Email</h3>
              <p><a href="https://www.gmail.com">harikrishna.g@gsv.ac.in</a></p>
              <p><a href="https://www.gmail.com">shivam.pathak_mba23@gsv.ac.in</a></p>
              <p><a href="https://www.gmail.com"></a></p>
            </div>
          </div>
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 footer-info">
            <h3>GSV Internship Portal</h3>
            <p>This is a Website where company can post an internship and student can apply for that. This Website is developed by the students of GSV.</p>
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h4>Contact Us</h4>
            <p>
             Gati Shakti Vishwavidyalaya, A Central University under the Ministry of Railways, Government of India, Lalbaug, Vadodara, Gujarat, 390004 <br>
              <strong>Phone:</strong> 9313921042<br>
              <!-- <strong>Fax:</strong> 022-61115400<br> -->
              <strong>Email:</strong> harikrishna.g@gsv.ac.in<br>
            </p>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong>GSV Internship Portal</strong>. All Rights Reserved | The template is made by <span>Shivam Pathak</span>
      </div>
    </div>
  </footer>
